# -*- coding: utf-8 -*-
#
# TransitArt documentation build configuration file, created by
# TYPO3 extension sphinx on Wed, 16 Sep 2015 11:38:08 +0200.
#
...
project = u'TransitArt'
copyright = u'2015, Michalak Marcin'
...
htmlhelp_basename = 'transit_artdoc'
...
latex_documents = [
    ('Index', 'transit_art.tex', u'TransitArt',
     u'Michalak Marcin', 'manual'),
]
...
pdf_documents = [
    ('Index', 'transit_art', u'TransitArt',
     u'Michalak Marcin'),
]
...
texinfo_documents = [
    ('Index', 'transit_art', u'TransitArt',
     u'Michalak Marcin', 'TransitArt', 'One line description of project.',
     'Miscellaneous'),
]
